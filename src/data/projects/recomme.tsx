...
export const recommeProject = {
  ...
  stages: {
    problem: {
      content: (
        <div className="space-y-6">
          ...
          <p>The platform needed to be <strong>white-labelled</strong>, fitting invisibly within any brand's ecosystem with minimal setup or technical friction.</p>
    ...
    tension: {
      content: (
        <div className="space-y-6">
          <p>Re-Up was created to address one of fashion's biggest sustainability challenges, <strong>the environmental impact of textile waste</strong>. Millions of garments end up in landfill each year, and few consumers understand how to recycle them responsibly.</p>
    ...
    research: {
      ...
      media: (
        <div className="space-y-4">
          <figure className="space-y-3">
            <img src={r2} alt="Benchmarking existing fashion recycling programmes" className="w-full h-auto rounded-xl border border-zinc-200" />
            <figcaption className="text-sm text-zinc-600">Benchmarking existing fashion recycling programmes to identify UX opportunities.</figcaption>
          </figure>
          <figure className="space-y-3">
    ...
    results: {
      content: (
        <div className="space-y-6">
          <h3 className="text-lg font-semibold text-zinc-900 mt-6 mb-3">Validation & Impact</h3>
