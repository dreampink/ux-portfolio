...
export const mortgageHubProject = {
  ...
  stages: {
    problem: {
      content: (
        <div className="space-y-6">
          <p>Mortgage Hub aimed to revolutionize mortgage origination by uniting all key players—borrowers, brokers, and underwriters—on one seamless digital platform.</p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-zinc-700">
            ...
            <li><strong>Lack of clarity:</strong> No centralized hub for tracking case progress, borrower details, or document status.</li>
          </ul>
    ...
    tension: {
      content: (
        <div className="space-y-6">
          ...
          <p>Additionally, underwriters were skeptical about adopting new digital tools, having spent years relying on paper and email workflows. The solution needed to respect their habits while introducing <strong>clarity, speed, and automation</strong>.</p>
        </div>
      ),
      media: (
        <figure className="space-y-3">
    ...
    research: {
      content: (
        <div className="space-y-6">
          ...
          <p>These insights revealed opportunities for simplification, automation, and connection.</p>
        </div>
      ),
      media: (
    ...
    results: {
      content: (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-zinc-900">A New Way of Working</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-pink-500 pl-4">
              <h4 className="font-semibold text-zinc-900 mb-2">Empathy Drives Adoption</h4>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-semibold text-zinc-900 mb-2">Efficiency Requires Design Discipline</h4>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              <h4 className="font-semibold text-zinc-900 mb-2">Collaboration Transforms Outcomes</h4>
