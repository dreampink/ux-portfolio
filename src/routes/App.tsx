              ...
              <div className="bg-slate-50 border-b border-slate-200 px-6 py-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="text-xs text-slate-500">Ebe Akinfisoye</div>
                  </div>
                </div>
              </div>
              
              {/* Figma Canvas */}
              <div className="bg-slate-100 p-8 min-h-[600px]">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300 group cursor-pointer flex flex-col h-full">
                      ...
                      <p className="text-slate-600 mb-6 leading-relaxed">Professional networking and career opportunities, connect with me on there.</p>
                  ...
                  <div className="mt-12 flex items-center justify-center space-x-8">
                    ...
                    <div className="flex items-center space-x-2 text-slate-500">
                      ...
                      <span className="text-sm">Ready to collaborate</span>
                    </div>
                    <div className="flex items-center space-x-2 text-slate-500">
                      <span className="text-lg">💡</span>
                      <span className="text-sm">Full of ideas</span>
                    </div>
                  </div>
                </div>
              </div>
